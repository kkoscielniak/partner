	...
	class ContactDetails
	{
		...
		public function init() {
			$this->details = array(
                ...
                'address_gliwice' => array(
					'label' => __( 'Adres - Gliwice', 'contact' ),
					'input' => 'textarea'
				),

                'address_cracow' => array(
                    'label' => __( 'Adres - Kraków', 'contact' ),
                    'input' => 'textarea'
                ),

                'office_gliwice' => array(
                    'label' => __( 'Godziny otwarcia - Gliwice', 'contact' ),
                    'input' => 'textarea'
                ),

                'office_cracow' => array(
                    'label' => __( 'Godziny otwarcia - Kraków', 'contact' ),
                    'input' => 'textarea'
                )
			);
